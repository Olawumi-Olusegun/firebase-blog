  ...
  return (
    <section className='size flex gap-[4rem] relative'>
        ...
        <Modal modal={modal} setModal={setModal}>
            <div className={`fixed right-0 top-0 bottom-0 w-[18rem] bg-white md:relative flex-[1] border-l border-gray-300 p-[2rem] z-[30] transition-all duration-300 ${modal ? "translate-x-0" : "translate-x-[100%] md:translate-x-0"}`}>
